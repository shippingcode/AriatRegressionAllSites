...
public class NegativeAddAddressFITest extends BaseTest {
	...
	public void negativeAddAddressNOTest() {
		...
		addAddressPage.setDetailsAddress("444", "4444", ADDRESS, CITY, "Helsinki", POST_CODE, PHONE, ADDRESS_ID);
	...
	public void negativeAddAddressNOTestWildcards() {
		...
		myAccountPage = signInPage.returnMyAccountPage();
		addAddressPage = myAccountPage.returnAddAddressesPageMiddleNav();
		addAddressPage.setDetailsAddress("444", "4444", ADDRESSWILD, CITYWILD, "Helsinki", POST_CODEWILD, PHONEWILD, ADDRESS_IDWILD);
		addressesPage = addAddressPage.returnAddressesPage();
		logger.info("Finishing add negative address NO test");
	}
	...
	public void negativeAddAddressNOTestMissingValues() {
		...
		myAccountPage = signInPage.returnMyAccountPage();
		addAddressPage = myAccountPage.returnAddAddressesPageMiddleNav();
		addAddressPage.setDetailsAddress("444", "4444", ADDRESSWILD, CITYWILD, "Helsinki", null, null, null);
