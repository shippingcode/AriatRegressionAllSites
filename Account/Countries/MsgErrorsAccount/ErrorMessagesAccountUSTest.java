...
/*	@Test(priority = 0)
	...
	public void returningCustomerWrongPasswordTest() {
		...
		homePageUS = (HomePageUS) homePage.chooseEULocation(euCountry.USA, euCountry.USA.getCurrencyISO());
		signInPage = homePageUS.returnSignInPage();
		signInPage.setLoginDetails(CredentialsUtils.getProperty("email_US"), "EnglishUS", CredentialsUtils.getProperty("wrong_password"));
	...
	public void returningCustomerWrongEmailTest() {
		...
		homePageUS = (HomePageUS) homePage.chooseEULocation(euCountry.USA, euCountry.USA.getCurrencyISO());
		signInPage = homePageUS.returnSignInPage();
		signInPage.setLoginDetails(CredentialsUtils.getProperty("wrong_email"), "EnglishUS", CredentialsUtils.getProperty("ok_password"));
		signInPage.loginClick();
