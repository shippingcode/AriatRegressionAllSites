...
public class NegativeCheckoutCreateOrderNLTest extends BaseTest {
	...
	public void checkoutNegativeCreateOrderInvalidShippingAddress() {
		...
		checkoutProcessPage.setInfoAccountSecureCheckout(FIRST_NAME, LAST_NAME, ADDRESS, CITY, ZIP_CODE, MOBILE, CredentialsUtils.getProperty("email"), optionCountry.NETHERLANDS);
	...
	public void checkoutNegativeCreateOrderInvalidPaymentsDetails() {
		...
		checkoutPage = myBagPage.returnCheckoutPage();
		checkoutProcessPage = checkoutPage.returnCheckoutProcessPage();
		checkoutProcessPage.setInfoAccountSecureCheckout(FIRST_NAME1, LAST_NAME1, ADDRESS, CITY, ZIP_CODE1, MOBILE1, CredentialsUtils.getProperty("email"), optionCountry.NETHERLANDS);
