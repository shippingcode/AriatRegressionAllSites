...
public class NegativeCheckoutCreateOrderFRTest extends BaseTest {
	...
	public void checkoutNegativeCreateOrderInvalidPaymentsDetails() {
		...
		checkoutPage = myBagPage.returnCheckoutPage();
		checkoutProcessPage = checkoutPage.returnCheckoutProcessPage();
		checkoutProcessPage.setInfoAccountSecureCheckout(FIRST_NAME1, LAST_NAME1, ADDRESS, CITY, ZIP_CODE1, MOBILE1, CredentialsUtils.getProperty("email"), optionCountry.FRANCE);
