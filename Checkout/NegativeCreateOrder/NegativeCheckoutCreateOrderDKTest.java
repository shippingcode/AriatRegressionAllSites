...
public class NegativeCheckoutCreateOrderDKTest extends BaseTest {
	...
	public void checkoutNegativeCreateOrderInvalidPaymentsDetails() {
		...
		checkoutPage = myBagPage.returnCheckoutPage();
		checkoutProcessPage = checkoutPage.returnCheckoutProcessPage();
		checkoutProcessPage.setInfoAccountSecureCheckout(FIRST_NAME, LAST_NAME, ADDRESS, CITY, ZIP_CODE, MOBILE, CredentialsUtils.getProperty("email"), optionCountry.DENMARK);
