...
public class ProductAddToWishListWomenCategoryIETest extends BaseTest {
 ...
 @Test(priority=1)
	...
	public void productPageWomenCategoryAddToWishListCreateAccountTest() {
		...
		createAccountPage.createAccount(FIRST_NAME, LAST_NAME, BIRTH_MONTH, BIRTH_DAY, CredentialsUtils.getProperty("email"), CredentialsUtils.getProperty("email"), CredentialsUtils.getProperty("passowrd"), CredentialsUtils.getProperty("passowrd"));
