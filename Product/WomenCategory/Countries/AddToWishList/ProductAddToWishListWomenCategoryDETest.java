...
public class ProductAddToWishListWomenCategoryDETest extends BaseTest {
	...
	public void productPageWomenCategoryAddToWishListLoggedTest() {
		...
		signInPage.setLoginDetails(CredentialsUtils.getProperty("email_US"), "Deutsch", CredentialsUtils.getProperty("password"));
 ...
 @Test(priority=1)
	...
	public void productPageWomenCategoryAddToWishListCreateAccountTest() {
		...
		createAccountPage.createAccount(FIRST_NAME, LAST_NAME, BIRTH_MONTH, BIRTH_DAY, CredentialsUtils.getProperty("email_US"), CredentialsUtils.getProperty("email_US"), CredentialsUtils.getProperty("password"), CredentialsUtils.getProperty("password"));
